const translations = {
    en: {
        ...
        'about-text-2': 'developer with experience in modern web technologies, SQL and',
        'about-text-3': 'NoSQL databases, REST APIs, and AI integration. Passionate about',
        'about-text-4': 'clean code and solving complex problems.',
        'about-text-5': 'Science and mathematics are like captivating puzzles to me - I',
        'about-text-6': 'love diving into complex concepts and challenging logic problems.',
        'about-passions-1': '"Full-Stack Development"',
        'about-passions-2': '"AI & Machine Learning"',
        'about-passions-3': '"Database Architecture"',
        'about-passions-4': '"Visual Arts & Music"',
        'about-passions-5': '"Gaming & Game Dev"',
        'about-creative-1': '// On the creative side, I enjoy visual arts, music,',
        'about-creative-2': '// and game development with Godot and Blender',
    ...
    es: {
        ...
        'about-text-2': 'full-stack con experiencia en tecnologías web modernas, bases de',
        'about-text-3': 'datos SQL y NoSQL, APIs REST e integración de IA. Apasionado por',
        'about-text-4': 'el código limpio y resolver problemas complejos.',
        'about-text-5': 'La ciencia y las matemáticas son como puzzles cautivantes para mí -',
        'about-text-6': 'me encanta sumergirme en conceptos complejos y desafíos lógicos.',
        'about-passions-1': '"Desarrollo Full-Stack"',
        'about-passions-2': '"IA & Machine Learning"',
        'about-passions-3': '"Arquitectura de Bases de Datos"',
        'about-passions-4': '"Artes Visuales & Música"',
        'about-passions-5': '"Gaming & Desarrollo de Juegos"',
        'about-creative-1': '// En el lado creativo, disfruto las artes visuales, música',
...
function applyTranslations() {
    ...
    if (currentLang === 'es') {
        ...
        texts[2] = translations.es['typing-3'];
        texts[3] = translations.es['typing-4'];
        texts[4] = translations.es['typing-5'];
    } else {
        texts[0] = translations.en['typing-1'];
        texts[1] = translations.en['typing-2'];
        texts[2] = translations.en['typing-3'];
        texts[3] = translations.en['typing-4'];
